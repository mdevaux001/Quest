        ...
        <div class="col-md-6">
            ...
            <form class="form-signin form-horizontal" role="form" action="RepondreQuestionnaire.php" method="post">
                <div class="form-group">
                    ...
                    <div class="col-md-6 ">
                        <button type="submit" class="btn btn-default btn-primary" id="btncode"><span
                                    class="glyphicon glyphicon-circle-arrow-right"></span> start !
                        </button>
                    </div>
                </div>
        ...
        <div class="col-md-6">
            ...
            if (!empty($stmt)) {
                foreach ($stmt as $experience) { ?>
                    <article>
                        <h5><a class="nom_experience"
                               href="PageAcceuilExperience.php?id=<?= $experience['exr_id'] ?>"><?= $experience['exr_nom'] ?></a>
                        </h5>
